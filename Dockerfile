...
ENV NEXT_PUBLIC_FIREBASE_API_KEY=AIzaSyCHe7WXKlNDVweMbpjpq6IZtCGnyrjCji4
ENV NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=hr-app-475516.firebaseapp.com
ENV NEXT_PUBLIC_FIREBASE_PROJECT_ID=hr-app-475516
ENV NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=hr-app-475516.firebasestorage.app
ENV NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=965791636605
ENV NEXT_PUBLIC_FIREBASE_APP_ID=1:965791636605:web:c14292abf5c1e2d1ea2514
ENV NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID=G-VEJXXSRLJ5
ENV NEXT_PUBLIC_FIREBASE_VAPID_KEY=BMZOKaVTlFb08R8U9GT-yeImU55FLF_82_8H27jgPgCK_eSYs59BGtxm8qeZ_LRkls80Y6MJTLzZPUyP-f_D6U0
RUN bun run build
